...
ep = all_loss[:end_ep,0]
fig = plt.figure()

ax1 = fig.add_subplot(1, 2, 1)
ax2 = fig.add_subplot(1, 2, 2)

ax1.plot(ep, all_loss[:end_ep,1], 'r--', label='average train error')
ax1.plot(ep, all_loss[:end_ep,2], 'b--', label='dev error')
ax2.plot(ep, all_loss[:end_ep,3], 'g--', label='displacement error')
ax2.plot(ep, all_loss[:end_ep,4], 'y--', label='final dispplacement error')
